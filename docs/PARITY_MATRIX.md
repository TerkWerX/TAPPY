...
| Themes and responsive modes | First-slice | Family tokens plus owner-approved Tappy brand assets in the Tippy header/splash/About scheme | App tests cover mode minimums, live automation names, branding resources, icon frames, and high-contrast theme precedence; WPF resources compile | Manual light/dark/high-contrast, DPI, icon, and layout-mode accessibility checks |
